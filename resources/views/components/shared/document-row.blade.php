@props(['documentId' => null, 'fileName', 'filePath', 'createdAt', 'updatedAt'])

<tr class="border-b border-gray">
    <!-- <td class="px-4 py-2"><input type="checkbox" /></td> -->
    <td class="text-blue">
        <a href="{{ $documentId ? route('documents.view', $documentId) : asset('storage/' . $filePath) }}" target="_blank" class="flex items-center gap-4 py-3">
